...
export declare class ShoppingListController {
    ...
    getItemByCode(code: string, request: Request): Promise<import("../dto/return.dto").ReturnDataDto | import("../dto/return.dto").ReturnDto>;
    getItemById(id: string, request: Request): Promise<import("../dto/return.dto").ReturnDataDto | import("../dto/return.dto").ReturnDto>;
