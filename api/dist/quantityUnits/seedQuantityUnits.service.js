...
exports.QuantityUnitsSeedService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const quantityUnits_entity_1 = require("./entities/quantityUnits.entity");
let QuantityUnitsSeedService = class QuantityUnitsSeedService {
    constructor(repository) {
        this.repository = repository;
    }
    async seedQuantityUnits() {
...
exports.QuantityUnitsSeedService = QuantityUnitsSeedService;
exports.QuantityUnitsSeedService = QuantityUnitsSeedService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(quantityUnits_entity_1.QuantityUnits)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], QuantityUnitsSeedService);
//# sourceMappingURL=seedQuantityUnits.service.js.map